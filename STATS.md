...
```
careless.completeness ./careless_stats/thermolysin_dw/thl_1p8A_grid_both.mtz -i ./careless_stats/results/completeness.png -b 10 --show > ./careless_stats/results/completeness.txt
```
...
![image](./careless_stats/results/completeness.png)

```
cat ./careless_stats/results/completeness.txt
```
...
### $\text{I}/\sigma \text{I}$
```careless.isigi ./careless_stats/thermolysin_dw/thl_1p8A_grid_xval_[0-1].mtz --intensity-key I --uncertainty-key SigI -i ./careless_stats/results/isigi.png -b 10 --show```

![image](./careless_stats/results/isigi.png)
...
```
careless.ccpred ./careless_stats/thermolysin_dw/thl_1p8A_grid_predictions_[0-1].mtz -o ./careless_stats/results/ccpred_res.csv \
--image ./careless_stats/results/ccpred_careless.png -b 10 -m spearman -l 0.5 1.1 --show\
```

The raw plot from the above shell command is reproduced below. 

![image](./careless_stats/results/ccpred_careless.png)
...
```
careless.cchalf ./careless_stats/thermolysin_dw/*xval_both.mtz -o ./careless_stats/results/cchalf_res.csv \
 -i ./careless_stats/results/cchalf_res.png -b 10 -m spearman -l 0. 1. --show \
 ```

![image](./careless_stats/results/cchalf_res.png)
...
```
careless.ccanom ./careless_stats/thermolysin_dw/*xval_both.mtz -o ./careless_stats/results/ccanom_res.csv \
--image ./careless_stats/results/ccanom_res.png -b 10 -l 0. 0.3 --show
```
...
![image](./careless_stats/results/ccanom_res.png)
...
```
careless.rsplit ./careless_stats/thermolysin_dw/*xval_both.mtz -o ./careless_stats/results/rsplit_res.csv --image ./careless_stats/results/rsplit_res.png -b 10 -l 0 0.3 --show
```
![image](./careless_stats/results/rsplit_res.png)

A lower $R_\text{split}$ is better. 

### Image $CC_\text{pred}$
```
careless.image_ccpred ./careless_stats/thermolysin_dw/thl_1p8A_grid_predictions_[0-1].mtz -o ./careless_stats/results/imagecc_res.csv \
--image ./careless_stats/results/imagecc_careless.png -m weighted -l 0. 1.1 --show
```

![image](./careless_stats/results/imagecc_careless.png)
...
`careless.plot_history -s ./careless_stats/thermolysin_dw/thl_1p8A_grid_history.csv --show`
![image](./careless_stats/results/thl_plot_history.png)
...
`pd.read_csv("./careless_stats/thermolysin_dw/thl_1p8A_grid_history.csv"); 
...
`

![image](./careless_stats/results/loss_components.png)
